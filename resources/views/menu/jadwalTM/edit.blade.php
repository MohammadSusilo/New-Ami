...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ubah Jadwal TM</li>
            </ol>
          </div><!-- /.breadcrumb -->
        </div><!-- /.row container -->
    ...
    <section class="content">
      <div class="container-fluid">
      <!-- form start -->
      <form method="POST" action="{{ route('jadwalTM.update', $jadwalTM->id) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text"  id="datepicker" name="tahun" value="{{ $jadwalTM->tahun }}" class="form-control @error('tahun') is-invalid @enderror"  required/>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1" class="required">Tanggal TM</label>
                      <input type="text"  id="datepicker1" name="tglTM" value="{{ $jadwalTM->tglTM }}" class="form-control @error('tglTM') is-invalid @enderror"  required/>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Waktu TM</label>
                      ...
                      <div class="input-group timepicker pull-center" data-placement="bottom" data-align="top" data-autoclose="true"><input type="text" name="waktuTM" value="{{ $jadwalTM->waktuTM }}" class="form-control @error('waktu') is-invalid @enderror" required></div>
              ...
              <div class="card-footer">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateJadwalTM">
                    Submit
                </button>
              </div>

                <div class="modal fade" id="updateJadwalTM">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Ubah Jadwal TM</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        <p style="text-align: center;">Apakah anda akan mengubah data Jadwal TM : {{ $jadwalTM->tglTM }} !!!</p>
                        <center>
