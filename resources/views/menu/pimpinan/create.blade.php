...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pimpinan Baru</li>
            </ol>
          </div><!-- /.breadcrumb -->
        </div><!-- /.row container -->
    ...
    <section class="content">
      <div class="container-fluid">
      <!-- form start -->
      <form method="POST" action="{{ route('pimpinan.store') }}">
      @csrf
        <div class="row">
          <div class="col-12">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="select2 @error('pengelola') is-invalid @enderror" name="pengelola[]" id="pengelola" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                        <option>Select Pengelola...</option>
