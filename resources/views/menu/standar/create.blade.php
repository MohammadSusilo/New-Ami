        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">New Standar</li>
            </ol>
          </div>
          <div class="col-sm-4">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('kodeStandar') is-invalid @enderror" name="kodeStandar" value="{{ old('kodeStandar') }}" required autofocus placeholder="Enter Kode Standar">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('namaStandar') is-invalid @enderror" name="namaStandar" value="{{ old('namaStandar') }}" required placeholder="Enter Nama Standar">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kriteria</label>
                      <select class="form-control select2bs4 @error('kriteria') is-invalid @enderror" name="kriteria" style="width: 100%;" required>
                        <option disabled selected="selected" value="">Pilih Kriteria...</option>
