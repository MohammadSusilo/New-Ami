                                    ...
                                    <form onSubmit="return false">
                                        <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
                                            <div class="form-group">
                                                <p>Bagian ini mencakup latar belakang, tujuan, dan rasional penentuan strategi pencapaian standar pendidikan tinggi yang ditetapkan perguruan tinggi terkait penelitian.</p>
                                        ...
                                        <div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">
                                            <div class="form-group">
                                                <p>Bagian ini berisi deskripsi dokumen formal kebijakan penelitian yang mendorong adanya keterlibatan mahasiswa program studi dalam penelitian dosen. Kebijakan penelitian juga harus memastikan adanya peta jalan penelitian yang memayungi tema penelitian dosen dan mahasiswa.</p>
                                        ...
                                        <div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger3">
                                            <div class="form-group">
                                                <p>Bagian ini mencakup strategi UPPS dalam pencapaian standar pendidikan tinggi yang ditetapkan perguruan tinggi terkait penelitian dosen dan mahasiswa.</p>
                                        ...
                                        <div id="test-l-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger4">
                                            <div class="form-group">
                                                <h5>a.	Relevansi penelitian DTPS di UPPS</h5>
                                                <p>Bagian ini menjelaskan peta jalan yang memayungi tema penelitian dosen dan mahasiswa.  Pelaksanaan penelitian dosen dan mahasiswa sesuai dengan peta jalan penelitian. Evaluasi kesesuaian penelitian dosen dan mahasiswa terhadap peta jalan, dan menggunakan evaluasi untuk perbaikan relevansi penelitian dan pengembangan keilmuan.</p>
                                                <textarea id="summernote3_1">
                                                    Place <em>some</em> <u>text</u> <strong>here</strong>
                                                </textarea>
                                            </div>
                                            <div class="form-group">
                                                <h5>b.	Data penelitian dosen yang melibatkan mahasiswa disajikan dengan teknik representasi yang relevan</h5>
                                                <p>Bagian ini menjelaskan keterlibatan mahasiswa pada kegiatan penelitian DTPS dalam 3 tahun terakhir, kegiatan penelitian DTPS yang digunakan sebagai rujukan tema tesis atau disertasi mahasiswa dalam 3 tahun terakhir.</p>
                                        ...
                                        <div id="test-l-5" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger5">
                                            <div class="form-group">
                                                <p>Bagian ini menjelaskan indikator kinerja tambahan penelitian yang berlaku di UPPS berdasarkan standar pendidikan tinggi yang ditetapkan perguruan tinggi untuk melampaui SN-DIKTI.</p>
                                        ...
                                        <div id="test-l-7" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger7">
                                            <div class="form-group">
                                                <p>Bagian ini berisi ringkasan dari pemosisian, masalah dan akar masalah, serta rencana perbaikan dan pengembangan UPPS terkait kegiatan penelitian pada program studi  yang diakreditasi.</p>
