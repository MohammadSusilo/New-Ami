...
@section('title', 'LAM TEKNIK ~ KRITERIA | Pengabdian kepada Masyarakat')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>LAM TEKNIK - KRITERIA | Pengabdian kepada Masyarakat</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kriteria | Pengabdian kepada Masyarakat</li>
            </ol>
          </div>   
          <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">LAM Teknik - Kriteria | Pengabdian kepada Masyarakat</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <form onSubmit="return false">
                                        <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
                                            <div class="form-group">
                                                <p>Bagian ini mencakup latar belakang, tujuan, dan rasional penentuan strategi pencapaian standar pendidikan tinggi yang ditetapkan perguruan tinggi terkait pengabdian kepada masyarakat (PkM).</p>
                                        ...
                                        <div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">
                                            <div class="form-group">
                                                <p>Bagian ini berisi deskripsi dokumen formal kebijakan PkM yang mendorong adanya keterlibatan mahasiswa program studi dalam PkM dosen. Kebijakan PkM juga harus memastikan adanya peta jalan PkM yang memayungi tema PkM dosen dan mahasiswa.</p>
                                        ...
                                        <div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger3">
                                            <div class="form-group">
                                                <p>Bagian ini mencakup strategi UPPS dalam pencapaian standar pendidikan tinggi yang ditetapkan perguruan tinggi terkait PkM dosen dan mahasiswa.</p>
                                        ...
                                        <div id="test-l-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger4">
                                            <div class="form-group">
                                                <h5>a.	Relevansi PkM DTPS di UPPS</h5>
                                                <p>Bagian ini menjelaskan peta jalan yang memayungi tema PkM dosen dan mahasiswa serta hilirisasi/penerapan keilmuan program studi yang diakreditasi, dosen dan mahasiswa melaksanakan PkM sesuai dengan peta jalan PkM, Evaluasi kesesuaian PkM dosen dan mahasiswa terhadap peta jalan, dan menggunakan hasil evaluasi untuk perbaikan relevansi PkM dan pengembangan keilmuan program studi yang diakreditasi.</p>
                                                <textarea id="summernote3_1">
                                                    Place <em>some</em> <u>text</u> <strong>here</strong>
                                                </textarea>
                                            </div>
                                            <div class="form-group">
                                                <h5>b.	Data PkM dosen yang melibatkan mahasiswa</h5>
                                                <p>Bagian ini menjelaskan keterlibatan mahasiswa pada kegiatan PkM DTPS dalam 3 tahun terakhir.</p>
                                        ...
                                        <div id="test-l-5" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger5">
                                            <div class="form-group">
                                                <p>Bagian ini menjelaskan indikator kinerja tambahan PkM yang berlaku di UPPS   berdasarkan standar pendidikan tinggi yang ditetapkan perguruan tinggi untuk melampaui SN-DIKTI.</p>
                                        ...
                                        <div id="test-l-7" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger7">
                                            <div class="form-group">
                                                <p>Bagian ini berisi ringkasan dari pemosisian, masalah dan akar masalah, serta rencana perbaikan dan pengembangan UPPS terkait kegiatan PkM pada program studi yang diakreditasi.</p>
