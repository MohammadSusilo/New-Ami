...
@section('title', 'LAM TEKNIK ~ BAB V PENUTUP')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>LAM TEKNIK - BAB V PENUTUP</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              @endif
              <li class="breadcrumb-item active">BAB V Penutup</li>
            </ol>
          </div>   
          <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">LAM Teknik - BAB V PENUTUP</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      @if($LAMTeknikLEDPenutup == null)
                        <form action="{{ route('LAMTeknik_LED_Penutup.store') }}" method="post">
                          @csrf
                            <center><h3>PENUTUP</h3></center>
                            ...
                            <textarea name="penutup" class="summernotes" rows="4">
                            </textarea>
                      ...
                      @else
                        <form action="{{ route('LAMTeknik_LED_Penutup.update', $LAMTeknikLEDPenutup->id) }}" method="post" class="f1">
                          @csrf
                          @method('PUT')
                            <center><h3>PENUTUP</h3></center>
                            <div class="form-group">
                            ...
                            <div class="text-right">
                              ...
                              <form onclick="return confirm('Apakah anda yakin reset data ini?');" action="{{ route('LAMTeknik_LED_Penutup.destroy', $LAMTeknikLEDPenutup->id) }}" method="POST" class="is-inline">
                                @csrf
                                @method('DELETE')
