...
@section('title', 'History Kinerja Unit')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">History Kinerja Unit</li>
            </ol>
          </div><!-- /.breadcrumb -->
        </div><!-- /.row container -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">History Kinerja Unit</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive pad">
                <table id="historyKinerjaUnit" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Renop</th>
