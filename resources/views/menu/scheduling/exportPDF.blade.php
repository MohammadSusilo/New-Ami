...
<html lang="en">
  <head>
    ...
    <title>Jadwal Audit Mutu Internal</title>
      ...
      <thead>
          ...
          <th colspan="6">
            <table class="header" border="2">
              <thead>
                ...
                <tr class="rawheader">
                  <th class="colheader" rowspan="3" style="vertical-align: middle;text-align: center; width: 50%"><p class="tulisan">JADWAL AUDIT MUTU INTERNAL </p></th>
        ...
        <!-- <tr rowspan="6">
          <th colspan="6" style="vertical-align: middle;text-align: center; width: 100%">          
            <p class="tulisan">JADWAL<br> AUDIT MUTU INTERNAL PERIODE {{$jadwalAudit_->periode}} TAHUN {{$jadwalAudit_->tahun}} <br> POLITEKNIK NEGERI SEMARANG</p>
          </th>
        </tr> -->
        <!-- <tr>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">No</th>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">Auditor</th>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">Area Audit</th>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">Auditee</th>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">Tanggal</th>
          <th style="vertical-align: middle;text-align: center; width: 10%; border: 1px solid black; border-collapse: collapse;">Waktu</th>
        </tr> -->
      </thead>
      <tbody>
        <tr rowspan="6">
          ...
          <tr>
            ...
            <td style="border: 1px solid black; border-collapse: collapse; text-align: left">
                @foreach ($unitKerja as $unitKerjas)
                  @if($unitKerjas->id == $value->unitkerja_id)
                    {{ $unitKerjas->name }}
                  @endif
                @endforeach
            </td>
            ...
            <td style="border: 1px solid black; border-collapse: collapse; text-align: left">
                <center>
                    @php $tgl = explode("#", $value->tglAudit); @endphp
                    {{ date('d F Y', strtotime($tgl[0])) }} - {{ date('d F Y', strtotime($tgl[1])) }}
                </center>
            </td>
            <td style="border: 1px solid black; border-collapse: collapse; text-align: center">
                <center>
                    @php $time = explode("#", $value->waktu); @endphp
                    {{ date('H:i', strtotime($time[0])) }} - {{ date('H:i', strtotime($time[1])) }}
                </center>
            </td>
          </tr>
        @endforeach
