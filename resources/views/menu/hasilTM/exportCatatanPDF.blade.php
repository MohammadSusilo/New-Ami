...
<html lang="en">
  <head>
    ...
    <title>Catatan Status Tindak Lanjut Tinjauan Manajemen -</title>
          ...
          <th colspan="5">
            <table class="header" border="2">
              <thead>
                ...
                <tr class="rawheader">
                  <th class="colheader" rowspan="3" style="vertical-align: middle;text-align: center; width: 50%"><p class="tulisan">CATATAN STATUS <br> TINDAK LANJUT <br> TINJAUAN MANAJEMEN</p></th>
      ...
      <tbody style="border: 1px solid black; border-collapse: collapse;">
        <tr>
          <th colspan="5" style="vertical-align: middle;text-align: center; width: 100%">          
            <p class="tulisan">CATATAN STATUS TINDAK LANJUT TINJAUAN MANAJEMEN</p>
          </th>
        </tr>
        ...
        <tr>
          ...
          <th style="border: 1px solid black; text-align: center; vertical-align: middle;"><i>Follow Up</i></th>
          <th style="border: 1px solid black; text-align: center; vertical-align: middle;">PIC</th>
          <th style="border: 1px solid black; text-align: center; vertical-align: middle;">Status Penyelesaian</th>
        </tr>
        </thead>
        <tbody>
        @foreach($catatanTM as $key=>$value)
          <tr>
            ...
            @foreach($tindakLanjut as $tindak)
              ...
              <!-- <td> -->
                <td style="border: 1px solid black; vertical-align: middle;">{{ $value->tindakLanjut }}</td>
                ...
                <td style="border: 1px solid black; vertical-align: middle;">
                  @if($value->statusTindakTM == "selesai")
                    Selesai
                  @else
                    Tidak Selesai
                  @endif
