                        ...
                        <td>
                          <div class="btn-group">
                            <div style="margin:5px">
                              <!-- Show -->
                              <a href="{{ route('renop.show', $faqs->id) }}">
                            ...
                            <div style="margin:5px">
                              <!-- Edit -->
                              <a href="{{ route('renop.edit', $faqs->id) }}">
                            ...
                            <div style="margin:5px">
                              <!-- Destroy -->
                              <!-- <form onclick="return confirm('Apakah anda yakin hapus data ini?');" action="{{ route('renop.destroy', $faqs->id) }}" method="POST" class="is-inline">
                                  @csrf
                                  @method('DELETE')
                              ...
                              <div class="modal fade" id="deleteRenop{{ $faqs->id}}">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              <form action="{{ route('renop.destroy', $faqs->id) }}" method="POST" class="is-inline">
                                                  @csrf
                                                  @method('DELETE')
