			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="{{ route('password.update') }}" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Valid email is: spmi@gmail.com">
						...
						<input class="input100" type="text" name="email" placeholder="Type your Email" value="{{ $email ?? old('email') }}">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">New Password</span>
						<span class="btn-show-pass-1">
					...
					<div class="wrap-input100 validate-input" data-validate="Confrim Password is required">
						<span class="label-input100">Confrim Password</span>
						<span class="btn-show-pass-2">
							<i class="zmdi zmdi-eye"></i>
						</span>
						<input class="input100" type="password" name="password_confirmation" placeholder="Type your confrim password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
